...
function(define_build_mode mode)
    ...
    if(DEFINE_BUILD_C_COMPILER_FLAGS)
        ...
        set(HAVE_BUILD_MODE_C_FLAGS 1)
    endif()
    if(DEFINE_BUILD_CXX_COMPILER_FLAGS)
        check_cxx_compiler_flag("${DEFINE_BUILD_CXX_COMPILER_FLAGS}" HAVE_BUILD_MODE_CXX_FLAGS)
    else()
        set(HAVE_BUILD_MODE_CXX_FLAGS 1)
    endif()
    unset(CMAKE_REQUIRED_FLAGS)

    if(NOT HAVE_BUILD_MODE_C_FLAGS OR NOT HAVE_BUILD_MODE_CXX_FLAGS)
        message(VERBOSE "Skipping build mode definition due to unavailable flags: ${mode}")
        return()
    endif()
